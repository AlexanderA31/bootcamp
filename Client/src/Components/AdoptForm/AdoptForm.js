...
function AdoptForm(props) {
  ...
  return (
    <div className="custom-adopt-form-container">
      <h2 className="custom-form-heading">Solicitud de Adopción de Mascotas</h2>
      <div className="form-pet-container">
        ...
        <div className="form-div">
          <form onSubmit={handleSubmit} className="custom-form">
            ...
            <div className="custom-input-box">
              <label className="custom-label">Situación de Vivienda de la Mascota:</label>
              <input
                type="text"
            ...
            <div className="custom-input-box">
              <label className="custom-label">Experiencia Previa con Mascotas:</label>
              <input
                type="text"
            ...
            <div className="custom-input-box">
              <label className="custom-label">Otras Mascotas:</label>
              <input
                type="text"
            ...
            {formError && (
              <p className="error-message">Por favor, rellene todos los campos.</p>
            )}
            ...
            {SuccPopup && (
              <div className="popup">
                <div className="popup-content">
                  <h4>
                    El formulario de adopción de {props.pet.name} ha sido enviado; nos pondremos en contacto con usted pronto para continuar con el proceso.
                  </h4>
                </div>
                <button onClick={(e) => {
