      ...
      <div className="homeContainer-left">
        <div>
          <p className="home-title">
            ...
            <p>Tus Mascotas </p><img src={homepageDog} alt="Dog sitting"/>
            </div>
            Son Nuestra
            <br />
            Prioridad
        ...
        <div className="adopt-btn">
          <Link to='./pets'><button className="Home-button" onClick={scrollToTop}><p>Adoptar una Mascota</p><img src={footPrint} alt="footprint" /></button></Link>
        </div>
      </div>
