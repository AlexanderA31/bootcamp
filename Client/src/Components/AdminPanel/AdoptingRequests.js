  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        <p>No hay solicitudes de adopción disponibles para ninguna mascota.</p>
      )}
          ...
          <div className='popup-content'>
            <div className='pet-view-card'>
              ...
              <div className='pet-card-details'>
                ...
                <p><b>Tipo:</b> {selectedPet.type}</p>
                <p><b>Edad:</b> {selectedPet.age}</p>
                <p><b>Ubicación:</b> {selectedPet.area}</p>
                <p><b>Correo Electrónico del Dueño:</b> {selectedPet.email}</p>
                <p><b>Teléfono del Dueño:</b> {selectedPet.phone}</p>
