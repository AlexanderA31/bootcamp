    ...
    <div className='req-containter'>
      <div className='pet-view-card'>
        ...
        <div className='pet-card-details'>
          ...
          <p><b>Correo Electrónico del Nuevo Dueño:</b> {props.pet.email}</p>
          <p><b>Teléfono del Nuevo Dueño:</b> {props.pet.phone}</p>
          <p><b>Adoptado: </b>{formatTimeAgo(props.pet.updatedAt)}</p>
        </div>
        <div className='app-rej-btn'>
          <button onClick={handleReject} disabled={isDeleting}>{isDeleting ? (<p>Eliminando</p>) : (props.deleteBtnText)}</button>
